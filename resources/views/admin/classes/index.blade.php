                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    @forelse($classList as $class)
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-8 h-8 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg flex items-center justify-center text-blue-700 text-xs font-bold mr-3">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="w-24 mt-1.5 bg-gray-100 rounded-full h-1.5 overflow-hidden">
                                        @php 
                                            ...
                                            $color = $percent >= 100 ? 'bg-red-500' : ($percent >= 80 ? 'bg-yellow-500' : 'bg-gradient-to-r from-blue-500 to-indigo-500');
                                        @endphp
