    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="px-8 pb-8">
            <div class="relative flex justify-between items-end -mt-12 mb-8">
                ...
                <div class="mb-2">
                    <span class="px-4 py-1.5 bg-blue-50 text-blue-600 text-xs font-black uppercase tracking-widest rounded-full border border-blue-100">
                        {{ Auth::user()->roles->first()?->name ?? 'Guru' }}
                    </span>
                </div>
            </div>
