            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    ...
                    <a href="{{ route('guru.agenda.index') }}" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-all group {{ request()->routeIs('guru.agenda.*') ? 'bg-blue-50 text-blue-600' : '' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('guru.agenda.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                        </svg>
                        <span class="ml-3 font-medium">Jurnal Mengajar</span>
                        @if(request()->routeIs('guru.agenda.*'))
                            <span class="ml-auto w-1.5 h-8 bg-blue-600 rounded-full"></span>
                        @endif
                    </a>
                    ...
                    <a href="{{ route('guru.attendance.index') }}" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-all group {{ request()->routeIs('guru.attendance.*') ? 'bg-blue-50 text-blue-600' : '' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('guru.attendance.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('guru.report.index') }}" 
                       class="flex items-center px-4 py-3 text-gray-700 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-all group {{ request()->routeIs('guru.report.*') ? 'bg-blue-50 text-blue-600' : '' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('guru.report.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(Auth::user()->hasRole('wali_kelas') || Auth::user()->hasRole('wakasek_kurikulum'))
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="relative" x-data="{ profileOpen: false }">
                                ...
                                <div x-show="profileOpen" @click.away="profileOpen = false"
                                    ...
                                    <a href="{{ route('guru.profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Profil Saya</a>
                                    <hr class="my-1">
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
