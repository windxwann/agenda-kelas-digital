    ...
    <div class="mb-8">
        <nav class="flex mb-4 text-xs font-bold uppercase tracking-widest text-gray-400">
            <ol class="flex items-center space-x-2">
                ...
                <li><svg class="w-3 h-3 mx-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></li>
                <li class="text-blue-600">Tambah Baru</li>
            </ol>
        </nav>
        <h1 class="text-3xl font-black text-gray-900 tracking-tight">Buat Agenda Baru</h1>
        <p class="text-gray-500 mt-1 font-medium text-sm">Lengkapi formulir di bawah untuk mencatat agenda kegiatan kelas hari ini.</p>
    </div>
    ...
    <form id="agendaForm" action="{{ route('sekretaris.agenda.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" value="{{ $classes->first()->name }}" disabled
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative" id="room-select-wrapper">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-8 space-y-6">
                ...
                <!-- File Upload -->
                <div class="space-y-2">
                    <label class="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Lampiran Dokumen (Opsional)</label>
...
<script>
    ...
    // Map of teacher_id from subjects to auto-select teacher dropdown
    ...
    function buildSubjectOptions(subjects) {
        ...
        subjects.forEach(s => {
            ...
            opt.setAttribute('data-teacher', s.teacher_id);
    ...
    function fetchScheduleInfo(date) {
        ...
        fetch(`${API_URL}?date=${date}`)
            .then(r => r.json())
            .then(data => {
                buildSubjectOptions(data.subjects);
                buildRoomOptions(data.rooms);
    ...
    // On page load: fetch schedule for default date
    fetchScheduleInfo(document.getElementById('date').value);
</script>
@endpush
@endsection